          ...
          <div class="col-xl-12 col-lg-12">
               <div class="card shadow mb-4 border-success">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between border-success">
                         ...
                         <a href="<?= base_url('admin/users/add'); ?>" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Tambah Data</a>
                    </div>
                    <!-- Card Body -->
                    <div class="card-body">
...
<script>
     $(document).ready(function() {
          ...
          $(document).on('click', '.deleteUsers', function(e) {
               ...
               let id = $(this).data('id');
               let url = '/data/deleteUsers/' + id;

               // Konfirmasi penghapusan
               if (confirm('Apa kamu yakin ingin menghapus User ini?')) {
                    $.ajax({
                         url: url,
                         type: 'POST',
                         data: {

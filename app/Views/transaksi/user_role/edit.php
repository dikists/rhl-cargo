...
<div class="container-fluid">
    ...
    <form action="<?= base_url('admin/settings/update_role/' . $roles[0]['role_id']); ?>" method="POST">
        <div class="row mb-3">
            <!-- Area Chart -->
            <div class="col-xl-4 col-lg-4">
                <div class="card shadow mb-4 border-success">
                    ...
                    <!-- Card Body -->
                    <div class="card-body">
                        <input class="form-control" name="role_name" type="text" placeholder="Nama Role Baru" value="<?= $roles[0]['role_name']; ?>" required>
                    </div>
                </div>
            </div>
